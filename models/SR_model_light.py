...
from models.modules.IMDN.architecture import IMDN

class SR_model_light():
    def __init__(self, model_path, learning_rate=0.001, update_interval=5):
        ...
        self.optimizer = torch.optim.Adam(self.learn_model.parameters(), self.learning_rate)
        # 定义optimizer和损失函数
